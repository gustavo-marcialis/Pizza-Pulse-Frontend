...
import { EditPedidoDialog } from '@/components/EditPedidoDialog'; // ✅ Import Novo

interface PedidoCardProps {
  pedido: Pedido;
  canAdvanceStatus?: boolean;
  canEdit?: boolean; // ✅ Prop Nova
  index?: number;
}
      ...
      <Card className="overflow-hidden hover:shadow-warm transition-shadow duration-300 h-full flex flex-col">
        <CardHeader className="pb-3 bg-muted/20">
          <div className="flex items-center justify-between">
            ...
            {/* ✅ AQUI ESTÁ A MÁGICA: Botão de Editar */}
        ...
        {/* Rodapé só aparece para Pizzaiolo */}
        {canAdvanceStatus && (
